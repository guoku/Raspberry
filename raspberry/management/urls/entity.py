...
urlpatterns = patterns(
    ...
    url(r'^(?P<entity_id>\w+)/image/add/$', 'add_image_for_entity', name='add_image_for_entity'),
    url(r'^(?P<entity_id>\w+)/image/del/(?P<image_id>\w+)/$', 'del_image_from_entity', name='del_image_from_entity'),
    url(r'^(?P<entity_id>\w+)/taobao/item/load/$', 'load_taobao_item_for_entity', name='load_taobao_item_for_entity'),
    url(r'^(?P<entity_id>\w+)/taobao/item/add/$', 'add_taobao_item_for_entity', name='add_taobao_item_for_entity'),
