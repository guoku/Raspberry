...
urlpatterns = patterns('mobile.views',
    ...
    (r'^category/(?P<category_id>\d+)/candidate/$', 'category_candidate'),
    ...
    (r'^candidate/create/$', 'create_candidate'),
    (r'^candidate/(?P<candidate_id>\d+)/ask/(?P<target_status>\d+)/$', 'ask_link_for_candidate'),
